...
<html lang="en">
  ...
  <body>
    ...
    <!-- form -->
    <form action="handle_signup.php" class='center form' name="myForm" method="POST">
      <!-- text box -->
      <div class="row">
        <div class="col">
        ...
        <div class="col">
          ...
          <input id="passone" name="passone" type="password">
        </div>

        <div class="col">
          <label for="password">Verify Password</label><br>
          <input id="passtwo" name="passtwo" type="password">
        </div>
      </div>
      <br>
  ...
  <script>
    ...
    if (passone != '') {
      if (passone == passtwo) {
        ...
        match.innerHTML = 'make sure that your passwords match';
      }
    } 
    else {
      match.style.backgroundColor = 'red';
      match.innerHTML = 'you must enter a password';
    }
  </script>
</html>